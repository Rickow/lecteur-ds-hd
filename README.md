...
**GPL-3.0** (see [`LICENSE`](LICENSE)). Component list, GitHub links and licenses in
[**CREDITS.md**](CREDITS.md). The project embeds EmulatorJS (GPL-3.0) and the DeSmuME
core (GPL-2.0). No ROM or BIOS is distributed.
